  ...
  return (
    <main>
      ...
      <article className="mx-auto max-w-[720px] px-6 py-16 lg:py-24">
        ...
        <h1 className="mb-4 font-display text-h1 text-ink-900">{title}</h1>
        <p className="mb-12 measure text-sm text-gold-700">
          Este texto es una estructura de referencia derivada del PRD del
          proyecto — pendiente de revisión por un abogado ecuatoriano antes de
          publicarse (PRD §14).
        </p>
